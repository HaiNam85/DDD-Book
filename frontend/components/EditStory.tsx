...
export default function EditStory({ id }: EditStoryProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await stories.update(id, formDataToSend, {
        headers: {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-center">Edit Story</h1>
